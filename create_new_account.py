...
#Buttons
generate_ac_no_btn=Button(root, text=("Generate AC No"), font=("Arial Bold", 12), fg="white", bg="#fccc74", width=15, cursor="hand2", command=generate_ac_no)
generate_ac_no_btn.place(x=100, y=420)

submit_btn=Button(root, text=("Submit"), font=("Arial Bold", 12),fg="white",bg="blue",width=10,cursor="hand2",command=submit)
