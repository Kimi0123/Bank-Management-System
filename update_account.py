...
search_btn = Button(root, text="Search", font=("Arial Bold", 12), fg="white", bg="blue", width=10, cursor="hand2", command=search)
...
update_btn = Button(root, text="Update", font=("Arial Bold", 12), fg="white", bg="gray20", width=10, cursor="hand2", command=update)
