...
account_number_label = Label(root, text="Acount Number ", font=("Arial", 12, "bold"),fg="red")
account_number_label.grid(row=1, column=1,padx=40,pady=20)

name_label = Label(root, text="Name  ", font=("Arial", 12, "bold"),fg="red")
name_label.grid(row=1, column=2,padx=70,pady=20)

gender_label = Label(root, text="Gender ", font=("Arial", 12, "bold"),fg="red")
gender_label.grid(row=1, column=3,padx=10,pady=20)

dob_label = Label(root, text="DOB  ", font=("Arial", 12, "bold"),fg="red")
dob_label.grid(row=1, column=4,padx=40,pady=20)

email_label = Label(root, text="Email ", font=("Arial", 12, "bold"),fg="red")
email_label.grid(row=1, column=5,padx=60,pady=20)

phone_number_label = Label(root, text="PhoneNumber", font=("Arial", 12, "bold"),fg="red")
phone_number_label.grid(row=1, column=6,padx=30,pady=20)

address_label = Label(root, text="Address", font=("Arial", 12, "bold"),fg="red")
address_label.grid(row=1, column=7,padx=50,pady=20)

current_balance_label = Label(root, text="NPR", font=("Arial", 12, "bold"),fg="red")
